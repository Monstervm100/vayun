...
| 🛠️ **Admin** — content inventory, verified puzzle library, visit tracker | `/admin` |
...
Windows one-click: double-click `Start ChessMaster Academy.bat`.

## Deploy on Vercel (free)

Import the repo at vercel.com/new and set **Root Directory = `chessmaster-academy/frontend`**.
Full walkthrough: [docs/06-free-hosting-vercel.md](docs/06-free-hosting-vercel.md).
